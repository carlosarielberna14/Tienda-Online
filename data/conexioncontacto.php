<?php
 ...
 class Conexion{
  ...
  function conectar(){
    ...
    function mostrarDato($fecha,$nombre,$correo,$asunto,$mensaje){
        $con = $this->conectar();
        ...
        $stmt = $con->prepare('INSERT INTO comentario(fecha, nombre, correo,asunto,mensaje) VALUES (:fecha,:nombre,:correo,:asunto,:mensaje)');
        $rows = $stmt->execute(array(':fecha'=>$fecha, ':nombre'=>$nombre, ':correo'=>$correo,':asunto'=>$asunto,':mensaje'=>$mensaje));
